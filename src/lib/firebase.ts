 ...
 * Blindagem absoluta contra a instância '(default)' para evitar inconsistências.
 */
...
// Durante SSR, o Firestore pode não estar disponível imediatamente, então tratamos com resiliência.
